...
Customer.delete_all()
    ...
    ticket4 = Ticket.new({'film_id' => film1.id, 'customer_id' => customer2.id, 'screening_id' => screening1.id})
    ...
    ticket7 = Ticket.new({'film_id' => film1.id, 'customer_id' => customer4.id, 'screening_id' => screening1.id})
